...
class Assignment:
    def __init__(self, id: int, title: str, description: str, deadline: str, subject: str, teacher_id: int, class_id: str,difficulty: str = "o'rta"):
        ...
        if not class_id or validate_class_id(class_id):
